/* ==========================================================================
   ...
   character — персонаж в шапке группы:
     ...
     w, h    — размеры файла. Без них браузер не знает, сколько места
               занять под ленивую картинку, и вёрстка прыгает при загрузке
     overlap — на сколько пикселей плашка заходит под персонажа
               (по умолчанию 110); меньше — если арт «занимает» этот край
     offsetY — сдвиг персонажа вниз в пикселях
   ========================================================================== */
...
window.APP_GROUPS = [
...

  {
    ...
    /* Этот арт держится рукой за край: плашка, заходящая под персонажа
       на обычные 110 px, срезала бы кисть. Уменьшенный нахлёст и сдвиг
       вниз убирают наложение. */
    character: { file: "interface.webp", side: "left", w: 421, h: 593, overlap: 34, offsetY: 26 },
    subs: [
      { cat: "gui",       icon: "gui" },
